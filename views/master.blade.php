	...
	<body>
					...
					<div class="container">
						...
						<div class="nav-collapse collapse">
							...
							<?php if (isset($this->currentUser)) { ?>
								...
								<?php } ?>
								<li @if (isset($nav) && $nav=='imovels') class="active"@endif><a href="./imovels">Imovels</a></li>
								<li @if (isset($nav) && $nav=='tipoimovels') class="active"@endif><a href="./tipoimovels">TipoImovels</a></li>
								</ul>
								</li>
							</ul>
		...
		@section('container')
			...
			<div class="container">
				...
				<footer>
					<p class="muted"><small>&copy; <?php echo date('Y'); ?> Imoveis</small></p>
				</footer>
