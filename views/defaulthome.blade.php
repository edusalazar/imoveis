...
@section('title')Imoveis | Home@endsection
...
@section('container')
	...
	<div class="container">
		...
		<div class="hero-unit">
			...
			<p><em>Gerado com Phreeze Modificado vers&atilde;o 3.3.9 CARPANESE.
			Rodando com Phreeze {{$PHREEZE_VERSION}}@if($PHREEZE_PHAR) 
			({{basename($PHREEZE_PHAR)}})@endif.</em></p>
		...
		<footer>
			<p>&copy; <?php echo date('Y'); ?> Imoveis</p>
		</footer>
